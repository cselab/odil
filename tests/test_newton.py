...
def parse_args():
    ...
    parser.add_argument("--Nnet", type=int, default=5, help="Number of inputs and output in neural net")
...
def make_problem(args):
    ...
    state = odil.State(
        fields={
            ...
            "a": Array(np.zeros(args.Na, dtype=dtype)),
            "net": domain.make_neural_net([args.Nnet, args.Nnet], activation="none"),
        }
    )
