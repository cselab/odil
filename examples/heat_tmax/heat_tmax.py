...
def operator_heat(ctx):
    ...
    def stencil(name):
        ...
        fields = [roll(transform_u(roll(u, otx), extra, mod), np.negative(otx)) for u, otx in zip(fields, offsets)]
        return fields
...
def parse_args():
    ...
    parser.set_defaults(frames=4, plot_every=1000, report_every=1000, history_every=200)
